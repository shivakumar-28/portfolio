...
const ROWS = [
  [
    ...
    { title: "Web Technologies and Frameworks", items: ["HTML", "CSS", "JavaScript", "React", "Django"] },
    { title: "Databases & Tools", items: ["SQLite"] },
    { title: "AI & Concepts", items: ["LLM Engineering(pursuing)"] },
  ],
  [
    {
      title: "Core Concepts",
    ...
    {
      title: "Soft Skills",
      items: ["Teamwork", "Creativity", "Adaptability", "Communication"],
    },
    {
