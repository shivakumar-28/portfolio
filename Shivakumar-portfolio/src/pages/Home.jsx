...
export default function Home() {
  ...
  const quickLinks = [
    { img: githubLogo, title: 'GitHub', link: 'https://github.com/shivakumar-28' },
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/neela-shivakumar-1b773a305' },
    { img: gmailLogo, title: 'Email', link: 'mailto:neelashivakumar524@gmail.com' },
    { img: whatsappLogo, title: 'WhatsApp', link: 'https://wa.me/+917702710299' }
  ]
  ...
  return (
    <section className="home-section">
      ...
      <style>
        {`
          @keyframes typing { from { width: 0; } to { width: 43%; } }
        ...
        >
          ...
          <motion.div className="info-cards">
            {[
              ...
              { label: '📧 Contact', value: 'neelashivakumar524@gmail.com' },
            ].map((info, i) => (
