  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I’m <strong>NEELA SHIVA KUMAR</strong> — an aspiring{" "}
          <strong>AI Engineer</strong> and{" "}
          <strong>Full Stack Developer</strong> who loves to build intelligent,
          user-centric applications. By crafting effective prompts and integrating AI capabilities into responsive web interfaces, I create solutions that are both functional and engaging.
        </p>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Matrusri Engineering College(MECS)</strong> — Saidabad, Hyderabad,
                  Telangana.
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  3rd Year (Pursuing) | CGPA: 8.31
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Sri Chaitanya Jr. College</strong> — RK puram,
                  Hyderabad, Telangana.
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Telangana Board | Percentage: 93.8%
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Abhyas Techno High School</strong> — Miryalaguda, Nalgonda,
                  Telangana.
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Telangana Board | Percentage: 100%
                </p>
